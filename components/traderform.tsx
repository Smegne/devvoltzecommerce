...
export default function TraderForm() {
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.shopLogo) {
      ...
      if (formData.shopLogo.size > 5 * 1024 * 1024) { // 5MB
        newErrors.shopLogo = 'File size must be less than 5MB';
      }
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.shopLogo) {
        console.log('📤 Including shop logo in submission');
        formDataToSend.append('shopLogo', formData.shopLogo);
      } else {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-[#0088CC] to-[#051935] rounded-2xl shadow-2xl mb-6">
          <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
          </svg>
        </div>
        <h1 className="text-4xl font-bold bg-gradient-to-r from-[#051935] to-[#0088CC] bg-clip-text text-transparent mb-4">
          Start Your Shop on DevVoltz
        </h1>
      ...
      {/* Success Message */}
      {successMessage && (
        <div className="mb-8 p-6 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl shadow-lg transform transition-all duration-500 scale-100">
              ...
              {showLoginPrompt && (
                <div className="mt-4 p-4 bg-green-100 rounded-xl">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button
                      onClick={handleLoginRedirect}
                      className="bg-green-600 text-white px-6 py-3 rounded-xl hover:bg-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
                    >
                      🚀 Login to Dashboard
                    </button>
                    <button
                      onClick={() => setShowLoginPrompt(false)}
                      className="bg-gray-600 text-white px-6 py-3 rounded-xl hover:bg-gray-700 transition-all duration-300 transform hover:scale-105"
                    >
                      Continue Exploring
                    </button>
                  </div>
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
        {/* Form Header */}
        <div className="bg-gradient-to-r from-[#051935] to-[#0088CC] p-8 text-white">
          <h2 className="text-2xl font-bold mb-2">Trader Application Form</h2>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    value={formData.name}
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 bg-gray-50 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0088CC] focus:border-transparent transition-all duration-300 ${
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={4}
                    className={`w-full px-4 py-3 bg-gray-50 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0088CC] focus:border-transparent transition-all duration-300 resize-none ${
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#0088CC] focus:border-transparent transition-all duration-300 resize-none"
                  placeholder="Tell us about your shop, your products, and what makes you unique..."
                />
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="shopLogo" className="block text-sm font-semibold text-gray-700 mb-2">
                  Shop Logo <span className="text-gray-500 font-normal">(Optional)</span>
                </label>
                <div className={`border-2 border-dashed rounded-2xl p-8 text-center transition-all duration-300 ${
                  errors.shopLogo ? 'border-red-500 bg-red-50' : 'border-gray-300 bg-gray-50 hover:border-[#0088CC] hover:bg-blue-50'
                }`}>
                  <input
                    type="file"
                    id="shopLogo"
                  ...
                  >
                    <div className="w-16 h-16 bg-gradient-to-br from-[#0088CC] to-[#051935] rounded-2xl flex items-center justify-center">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                    ...
                    <button
                      type="button"
                      className="px-6 py-2 bg-white border-2 border-[#0088CC] text-[#0088CC] rounded-xl hover:bg-[#0088CC] hover:text-white transition-all duration-300"
                    >
                      Choose File
                    </button>
                  </label>
          ...
          <div className="pt-6">
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-[#0088CC] to-[#051935] text-white py-4 px-6 rounded-xl hover:shadow-2xl transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[#0088CC] focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 text-lg font-semibold"
            >
              {isLoading ? (
                ...
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span>Launch Your Shop Now</span>
                </div>
              )}
            </button>
          </div>
          ...
          {/* Error Message */}
          {errors.submit && (
            <div className="p-6 bg-red-50 border border-red-200 rounded-2xl transform transition-all duration-500 scale-100">
          ...
          <div className="text-center p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200">
            <p className="text-[#051935] text-lg font-semibold mb-3">
              Already have a trader account?
            </p>
            <button
              type="button"
              onClick={handleLoginRedirect}
              className="bg-white text-[#0088CC] border-2 border-[#0088CC] px-8 py-3 rounded-xl hover:bg-[#0088CC] hover:text-white transform hover:scale-105 transition-all duration-300 font-semibold shadow-lg"
            >
              🚀 Access Trader Dashboard
            </button>
          </div>
